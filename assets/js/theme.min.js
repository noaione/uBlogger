 ...
 */(function(a){"function"==typeof define&&define.amd?define(["jquery"],a):"object"===("undefined"==typeof module?"undefined":_typeof(module))&&"object"===_typeof(module.exports)?a(require("jquery")):a(jQuery)})(function(a){var f=Math.abs;function b(){var b=g.settings;//check if it's still visible
if(b.autoDispose&&!a.contains(document.documentElement,this))return a(this).timeago("dispose"),this;var h=c(this);return isNaN(h.datetime)||(0===b.cutoff||f(e(h.datetime))<b.cutoff?a(this).text(d(h.datetime)):0<a(this).attr("title").length&&a(this).text(a(this).attr("title"))),this}function c(b){if(b=a(b),!b.data("timeago")){b.data("timeago",{datetime:g.datetime(b)});var c=a.trim(b.text());g.settings.localeTitle?b.attr("title",b.data("timeago").datetime.toLocaleString()):0<c.length&&!(g.isTime(b)&&b.attr("title"))&&b.attr("title",c)}return b.data("timeago")}function d(a){return g.inWords(e(a))}function e(a){return new Date().getTime()-a.getTime()}// fix for IE6 suckage
a.timeago=function(b){return b instanceof Date?d(b):"string"==typeof b?d(a.timeago.parse(b)):"number"==typeof b?d(new Date(b)):d(a.timeago.datetime(b))};var g=a.timeago;a.extend(a.timeago,{settings:{refreshMillis:6e4,allowPast:!0,allowFuture:!1,localeTitle:!1,cutoff:0,autoDispose:!0,strings:{prefixAgo:null,prefixFromNow:null,suffixAgo:"ago",suffixFromNow:"from now",inPast:"any moment now",seconds:"less than a minute",minute:"about a minute",minutes:"%d minutes",hour:"about an hour",hours:"about %d hours",day:"a day",days:"%d days",month:"about a month",months:"%d months",year:"about a year",years:"%d years",wordSeparator:" ",numbers:[]}},inWords:function(b){var d=Math.round;function c(c,d){var f=a.isFunction(c)?c(d,b):c,g=e.numbers&&e.numbers[d]||d;return f.replace(/%d/i,g)}if(!this.settings.allowPast&&!this.settings.allowFuture)throw"timeago allowPast and allowFuture settings can not both be set to false.";var e=this.settings.strings,g=e.prefixAgo,h=e.suffixAgo;if(this.settings.allowFuture&&0>b&&(g=e.prefixFromNow,h=e.suffixFromNow),!this.settings.allowPast&&0<=b)return this.settings.strings.inPast;var i=f(b)/1e3,j=i/60,k=j/60,l=k/24,m=45>i&&c(e.seconds,d(i))||90>i&&c(e.minute,1)||45>j&&c(e.minutes,d(j))||90>j&&c(e.hour,1)||24>k&&c(e.hours,d(k))||42>k&&c(e.day,1)||5>l&&c(e.days,d(l))||c(e),n=e.wordSeparator||"";return void 0===e.wordSeparator&&(n=" "),a.trim([g,m,h].join(n))},parse:function parse(b){var c=a.trim(b);// +09 -> +0900
return c=c.replace(/\.\d+/,""),c=c.replace(/-/,"/").replace(/-/,"/"),c=c.replace(/T/," ").replace(/Z/," UTC"),c=c.replace(/([\+\-]\d\d)\:?(\d\d)/," $1$2"),c=c.replace(/([\+\-]\d\d)$/," $100"),new Date(c)},datetime:function datetime(b){var c=g.isTime(b)?a(b).attr("datetime"):a(b).attr("title");return g.parse(c)},isTime:function isTime(b){// jQuery's `is()` doesn't play well with HTML5 in IE
return"time"===a(b).get(0).tagName.toLowerCase();// $(elem).is("time");
}});// functions that can be called via $(el).timeago('action')
// init is default when no action is given
// functions are called with context of a single element
var h={init:function init(){h.dispose.call(this);var c=a.proxy(b,this);c();var d=g.settings;0<d.refreshMillis&&(this._timeagoInterval=setInterval(c,d.refreshMillis))},update:function update(c){var d=c instanceof Date?c:g.parse(c);a(this).data("timeago",{datetime:d}),g.settings.localeTitle&&a(this).attr("title",d.toLocaleString()),b.apply(this)},updateFromDOM:function updateFromDOM(){a(this).data("timeago",{datetime:g.parse(g.isTime(this)?a(this).attr("datetime"):a(this).attr("title"))}),b.apply(this)},dispose:function dispose(){this._timeagoInterval&&(window.clearInterval(this._timeagoInterval),this._timeagoInterval=null)}};a.fn.timeago=function(a,b){var c=a?h[a]:h.init;if(!c)throw new Error("Unknown function name '"+a+"' for timeago");// each over objects here and call the requested function
return this.each(function(){c.call(this,b)}),this},document.createElement("abbr"),document.createElement("time")});
"use strict";jQuery(document).ready(function(){jQuery("time.timeago").timeago()});
